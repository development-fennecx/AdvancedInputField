...
namespace NativeKeyboardUWP
{
	...
	public class CharacterCondition
	{
		...
		{
			conditionOperator = (CharacterConditionOperator)jsonObject["conditionOperator"].Integer;
			conditionIntValue1 = jsonObject["conditionIntValue1"].Integer;
			conditionIntValue2 = jsonObject["conditionIntValue2"].Integer;
			conditionStringValue = jsonObject["conditionStringValue"].String;
		}
