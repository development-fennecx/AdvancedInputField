...
namespace AdvancedInputFieldPlugin
{
    public class IOSKeyboardProxy
    {
        ...
        public IOSKeyboardProxy(IOSKeyboard keyboard)
        {
            ...
            _nativeKeyboard_initialize(OnTextEditUpdate, OnKeyboardShow, OnKeyboardHide, OnKeyboardDone, OnKeyboardNext, OnKeyboardCancel, OnSpecialKeyPressed, OnKeyboardHeightChanged, OnHardwareKeyboardChanged);
        }
