...
namespace AdvancedInputFieldPlugin
{
    ...
    public enum KeyboardType { DEFAULT, ASCII_CAPABLE, NUMBERS_AND_PUNCTUATION, URL, NUMBER_PAD, PHONE_PAD, EMAIL_ADDRESS }
    ...
    public partial class AdvancedInputField : Selectable, IPointerClickHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IUpdateSelectedHandler
    {
        ...
        public void SetCaretToVisibleTextStart()
        {
            if (text != null)
            {
                SetVisibleCaretPosition(0);
            }
            else
            {
        ...
        public void SetCaretToVisibleTextEnd()
        {
            if (text != null)
            {
                SetVisibleCaretPosition(text.Length);
            }
            else
            {
        ...
        public void SetTextCaretPosition(int caretPosition, bool invokeCaretPositonChangeEvent = false)
        {
            SetTextSelection(caretPosition, caretPosition);
        }
        ...
        public void SetTextSelectionStartPosition(int selectionStartPosition, bool invokeTextSelectionChangeEvent = false)
        {
            ...
            {
                SetTextSelection(selectionStartPosition, Engine.SelectionEndPosition);
            }
            else
            {
                SetTextSelection(selectionStartPosition, selectionStartPosition);
            }
        }
        ...
        public void SetTextSelectionEndPosition(int selectionEndPosition, bool invokeTextSelectionChangeEvent = false)
        {
            ...
            {
                SetTextSelection(Engine.SelectionStartPosition, selectionEndPosition);
            }
            else
            {
                SetTextSelection(selectionEndPosition, selectionEndPosition);
            }
        }
